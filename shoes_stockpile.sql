...
CREATE TABLE `stockpile` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_stockpile_brand_idx` (`id_brand`),
  CONSTRAINT `fk_stockpile_brand` FOREIGN KEY (`id_brand`) REFERENCES `brand` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-03-17 14:50:31
